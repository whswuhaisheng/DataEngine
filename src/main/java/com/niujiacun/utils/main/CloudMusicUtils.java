package com.niujiacun.utils.main;

import com.niujiacun.utils.entity.MusicCommentMessage;
import com.niujiacun.utils.service.*;
...
public class CloudMusicUtils {
    ...
    public static void main(String[] args) {
        String url = "http://music.163.com/#/song?id=28739658";
        try {
            CloudMusicUtils cloudMusicUtils = new CloudMusicUtils();
            cloudMusicUtils.Get_Url();
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
